...
function tablaAsignaturas($idCiclo, $idSalon, $conexion){
    $i = 1;
...
function tablaCompresionLectora(){

}

function tablaInasistencias(){

}

function tablaObsEspecificas(){

}

function tablaObsGenerales(){
